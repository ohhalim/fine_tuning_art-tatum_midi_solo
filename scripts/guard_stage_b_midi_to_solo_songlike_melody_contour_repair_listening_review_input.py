...
SCHEMA_VERSION = "stage_b_midi_to_solo_songlike_melody_contour_repair_listening_review_input_guard_v3"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--issue_number", type=int, default=1022)
