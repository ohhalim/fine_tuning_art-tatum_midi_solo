...
from utilities.constants import (  # noqa: E402
    STAGE_B_CHORD_QUALITIES,
    STAGE_B_CHORD_ROOTS,
    STAGE_B_MAX_DURATION_STEPS,
    STAGE_B_PIANO_PITCH_COUNT,
    STAGE_B_PIANO_PITCH_MAX,
    STAGE_B_PIANO_PITCH_MIN,
    STAGE_B_POSITIONS_PER_BAR,
    STAGE_B_VELOCITY_BINS,
    TOKEN_STAGE_B_CHORD_QUALITY_END,
    TOKEN_STAGE_B_CHORD_QUALITY_START,
    TOKEN_STAGE_B_CHORD_ROOT_END,
    TOKEN_STAGE_B_CHORD_ROOT_START,
    TOKEN_STAGE_B_END,
    TOKEN_STAGE_B_NOTE_DURATION_END,
    TOKEN_STAGE_B_NOTE_DURATION_START,
    TOKEN_STAGE_B_NOTE_PITCH_END,
    TOKEN_STAGE_B_NOTE_PITCH_START,
    TOKEN_STAGE_B_POSITION_END,
    TOKEN_STAGE_B_POSITION_START,
    TOKEN_STAGE_B_START,
    TOKEN_STAGE_B_VELOCITY_END,
    TOKEN_STAGE_B_VELOCITY_START,
    VOCAB_SIZE,
)
...
POSITIONS_PER_BAR = STAGE_B_POSITIONS_PER_BAR
MAX_DURATION_STEPS = STAGE_B_MAX_DURATION_STEPS
VELOCITY_BINS = STAGE_B_VELOCITY_BINS
PIANO_PITCH_MIN = STAGE_B_PIANO_PITCH_MIN
PIANO_PITCH_MAX = STAGE_B_PIANO_PITCH_MAX
PIANO_PITCH_COUNT = STAGE_B_PIANO_PITCH_COUNT

CHORD_ROOTS = STAGE_B_CHORD_ROOTS
CHORD_QUALITIES = STAGE_B_CHORD_QUALITIES

TOKEN_POSITION_START = TOKEN_STAGE_B_POSITION_START
TOKEN_POSITION_END = TOKEN_STAGE_B_POSITION_END
TOKEN_CHORD_ROOT_START = TOKEN_STAGE_B_CHORD_ROOT_START
TOKEN_CHORD_ROOT_END = TOKEN_STAGE_B_CHORD_ROOT_END
TOKEN_CHORD_QUALITY_START = TOKEN_STAGE_B_CHORD_QUALITY_START
TOKEN_CHORD_QUALITY_END = TOKEN_STAGE_B_CHORD_QUALITY_END
TOKEN_NOTE_PITCH_START = TOKEN_STAGE_B_NOTE_PITCH_START
TOKEN_NOTE_PITCH_END = TOKEN_STAGE_B_NOTE_PITCH_END
TOKEN_NOTE_DURATION_START = TOKEN_STAGE_B_NOTE_DURATION_START
TOKEN_NOTE_DURATION_END = TOKEN_STAGE_B_NOTE_DURATION_END
TOKEN_VELOCITY_START = TOKEN_STAGE_B_VELOCITY_START
TOKEN_VELOCITY_END = TOKEN_STAGE_B_VELOCITY_END

STAGE_B_TOKEN_START = TOKEN_STAGE_B_START
STAGE_B_TOKEN_END = TOKEN_STAGE_B_END
