...
SCHEMA_VERSION = "stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package_v4"
...
def validate_audio_package_report(
    ...
    *,
    ...
    return {"review_items": review_items, **source_context}
