...
Modes:
  ...
  stage-b-midi-to-solo-songlike-melody-contour-phrase-rhythm-repair-listening-review-input-guard
                Block phrase/rhythm repair preference fill while listening review input is pending.
  ...
  stage-b-midi-to-solo-songlike-melody-contour-phrase-rhythm-chord-tone-landing-repair-listening-review-package
                Package chord-tone landing repair WAV/MIDI candidates for listening review.
  stage-b-midi-to-solo-songlike-melody-contour-phrase-rhythm-chord-tone-landing-repair-listening-review-input-guard
                Block chord-tone landing repair preference fill while listening review input is pending.
  stage-b-midi-to-solo-songlike-melody-contour-phrase-rhythm-chord-tone-landing-repair-objective-only-next-decision
                Select objective-only next boundary after chord-tone landing input guard.
...
run_stage_b_midi_to_solo_targeted_quality_repair_sweep() {
  local labeling_run_id="${LABELING_RUN_ID:-harness_stage_b_midi_to_solo_candidate_failure_labeling_source_context_refresh}"
  local rubric_run_id="${RUBRIC_RUN_ID:-harness_stage_b_midi_to_solo_quality_rubric_baseline_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_targeted_quality_repair_sweep_source_context_refresh}"
...
run_stage_b_midi_to_solo_targeted_quality_repair_objective_only_next_decision() {
  ...
  if [[ ! -f "$input_guard_report" ]]; then
    print_header "Stage B MIDI-to-solo targeted quality repair listening review input guard"
    RUN_ID="$input_guard_run_id" run_stage_b_midi_to_solo_targeted_quality_repair_listening_review_input_guard
  fi
...
run_stage_b_midi_to_solo_songlike_melody_contour_repair_audio_package() {
  local sweep_run_id="${SWEEP_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_repair_sweep_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_repair_audio_package_source_context_refresh}"
  ...
  if [[ ! -f "$sweep_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour repair sweep"
    RUN_ID="$sweep_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_repair_sweep
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour repair audio package"
...
run_stage_b_midi_to_solo_songlike_melody_contour_repair_listening_review_package() {
  local audio_package_run_id="${AUDIO_PACKAGE_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_repair_audio_package_source_context_refresh}"
  local review_run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_repair_listening_review_package_source_context_refresh}"
  local audio_package_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_repair_audio_package/${audio_package_run_id}/stage_b_midi_to_solo_songlike_melody_contour_repair_audio_package.json"
  if [[ ! -f "$audio_package_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour repair audio package"
    RUN_ID="$audio_package_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_repair_audio_package
  fi
...
run_stage_b_midi_to_solo_songlike_melody_contour_repair_objective_only_next_decision() {
  local input_guard_run_id="${INPUT_GUARD_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_repair_listening_review_input_guard_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_repair_objective_only_next_decision_source_context_refresh}"
...
run_stage_b_midi_to_solo_songlike_melody_contour_repair_followup_decision() {
  ...
  if [[ ! -f "$objective_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour repair objective-only next decision"
    RUN_ID="$objective_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_repair_objective_only_next_decision
  fi
  if [[ ! -f "$sweep_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour repair sweep"
    RUN_ID="$sweep_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_repair_sweep
  ...
  "$PYTHON_BIN" scripts/decide_stage_b_midi_to_solo_songlike_melody_contour_repair_followup.py \
    --run_id "$run_id" \
    --objective_next_report "$objective_report" \
    --repair_sweep_report "$sweep_report" \
    ...
    --require_followup_decision \
    --require_phrase_rhythm_tie_target \
    --require_no_quality_claim
}
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package() {
  local audio_package_run_id="${AUDIO_PACKAGE_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_audio_package_source_context_refresh}"
  local review_run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package_source_context_refresh}"
  ...
  "$PYTHON_BIN" scripts/build_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package.py \
    --run_id "$review_run_id" \
    --audio_package_report "$audio_package_report" \
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_REPAIR_LISTENING_REVIEW_PACKAGE_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1116 \
    --expected_review_item_count 6 \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input_guard() {
  local package_run_id="${PACKAGE_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package_source_context_refresh}"
  local guard_run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input_guard_source_context_refresh}"
  local source_package="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package/${package_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package.json"
  if [[ ! -f "$source_package" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm repair listening review package"
    RUN_ID="$package_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_package
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm repair listening review input guard"
  "$PYTHON_BIN" scripts/guard_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input.py \
    --run_id "$guard_run_id" \
    --source_package "$source_package" \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_objective_only_next_decision() {
  local input_guard_run_id="${INPUT_GUARD_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input_guard_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_objective_only_next_decision_source_context_refresh}"
  local input_guard_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input_guard/${input_guard_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input_guard.json"
  if [[ ! -f "$input_guard_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm repair listening review input guard"
    RUN_ID="$input_guard_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_listening_review_input_guard
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm repair objective-only next decision"
  "$PYTHON_BIN" scripts/decide_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_objective_next.py \
    --run_id "$run_id" \
    --input_guard_report "$input_guard_report" \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_followup_decision() {
  ...
  if [[ ! -f "$objective_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm repair objective-only next decision"
    RUN_ID="$objective_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_objective_only_next_decision
  fi
  if [[ ! -f "$sweep_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm repair sweep"
    RUN_ID="$sweep_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_sweep
  ...
  "$PYTHON_BIN" scripts/decide_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_repair_followup.py \
    --run_id "$run_id" \
    --objective_next_report "$objective_report" \
    --repair_sweep_report "$sweep_report" \
    ...
    --require_followup_decision \
    --require_context_pitch_role_bridge \
    --require_no_quality_claim
}
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_audio_package() {
  local sweep_run_id="${SWEEP_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_sweep_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_audio_package_source_context_refresh}"
  ...
  "$PYTHON_BIN" scripts/render_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_audio.py \
    --run_id "$run_id" \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_package() {
  ...
  if [[ ! -f "$audio_package_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair audio package"
    RUN_ID="$audio_package_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_audio_package
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair listening review package"
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input_guard() {
  ...
  local guard_run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input_guard_source_context_refresh}"
  ...
  if [[ ! -f "$source_package" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair listening review package"
    RUN_ID="$package_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_package
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair listening review input guard"
  "$PYTHON_BIN" scripts/guard_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input.py \
    --run_id "$guard_run_id" \
    --source_package "$source_package" \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_only_next_decision() {
  local input_guard_run_id="${INPUT_GUARD_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input_guard_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_only_next_decision_source_context_refresh}"
  local input_guard_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input_guard/${input_guard_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input_guard.json"
  if [[ ! -f "$input_guard_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair listening review input guard"
    RUN_ID="$input_guard_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_listening_review_input_guard
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair objective-only next decision"
  "$PYTHON_BIN" scripts/decide_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_next.py \
    --run_id "$run_id" \
    --input_guard_report "$input_guard_report" \
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_CHORD_TONE_LANDING_REPAIR_OBJECTIVE_ONLY_NEXT_DECISION_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1136 \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_followup_decision() {
  local objective_run_id="${OBJECTIVE_NEXT_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_only_next_decision_source_context_refresh}"
  local sweep_run_id="${REPAIR_SWEEP_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_sweep_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_followup_decision_source_context_refresh}"
  local objective_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_only_next_decision/${objective_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_only_next_decision.json"
  local sweep_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_sweep/${sweep_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_sweep.json"
  if [[ ! -f "$objective_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair objective-only next decision"
    RUN_ID="$objective_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_objective_only_next_decision
  fi
  if [[ ! -f "$sweep_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing repair sweep"
    RUN_ID="$sweep_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_sweep
  ...
  "$PYTHON_BIN" scripts/decide_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_followup.py \
    --run_id "$run_id" \
    --objective_next_report "$objective_report" \
    --repair_sweep_report "$sweep_report" \
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_CHORD_TONE_LANDING_REPAIR_FOLLOWUP_DECISION_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1138 \
    ...
    --require_followup_decision \
    --require_outside_soloing_repair \
    --require_no_quality_claim
}

run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_sweep() {
  local followup_run_id="${FOLLOWUP_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_followup_decision_source_context_refresh}"
  local sweep_run_id="${CHORD_TONE_REPAIR_SWEEP_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_repair_sweep_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_sweep_source_context_refresh}"
  ...
  "$PYTHON_BIN" scripts/run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_sweep.py \
    ...
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_CHORD_TONE_LANDING_OUTSIDE_SOLOING_REPAIR_SWEEP_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1140 \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio_package() {
  local sweep_run_id="${SWEEP_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_sweep_source_context_refresh}"
  local run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio_package_source_context_refresh}"
  ...
  "$PYTHON_BIN" scripts/render_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio.py \
    ...
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_CHORD_TONE_LANDING_OUTSIDE_SOLOING_REPAIR_AUDIO_PACKAGE_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1142 \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package() {
  local audio_package_run_id="${AUDIO_PACKAGE_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio_package_source_context_refresh}"
  local review_run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package_source_context_refresh}"
  local audio_package_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio_package/${audio_package_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio_package.json"
  if [[ ! -f "$audio_package_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing outside-soloing repair audio package"
    RUN_ID="$audio_package_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_audio_package
  fi
  print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing outside-soloing repair listening review package"
  "$PYTHON_BIN" scripts/build_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package.py \
    --run_id "$review_run_id" \
    --audio_package_report "$audio_package_report" \
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_CHORD_TONE_LANDING_OUTSIDE_SOLOING_REPAIR_LISTENING_REVIEW_PACKAGE_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1144 \
    --expected_review_item_count 6 \
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_input_guard() {
  local review_package_run_id="${REVIEW_PACKAGE_RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package_source_context_refresh}"
  local guard_run_id="${RUN_ID:-harness_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_input_guard_source_context_refresh}"
  local review_package_report="outputs/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package/${review_package_run_id}/stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package.json"
  if [[ ! -f "$review_package_report" ]]; then
    print_header "Stage B MIDI-to-solo songlike melody contour phrase/rhythm chord-tone landing outside-soloing repair listening review package"
    RUN_ID="$review_package_run_id" run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_listening_review_package
  fi
...
run_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_objective_only_next_decision() {
  ...
  "$PYTHON_BIN" scripts/decide_stage_b_midi_to_solo_songlike_melody_contour_phrase_rhythm_chord_tone_landing_outside_soloing_repair_objective_next.py \
    --run_id "$run_id" \
    --input_guard_report "$input_guard_report" \
    --doc_path docs/STAGE_B_MIDI_TO_SOLO_SONGLIKE_MELODY_CONTOUR_PHRASE_RHYTHM_CHORD_TONE_LANDING_OUTSIDE_SOLOING_REPAIR_OBJECTIVE_ONLY_NEXT_DECISION_SOURCE_CONTEXT_REFRESH_2026-06-11.md \
    --issue_number 1148 \
