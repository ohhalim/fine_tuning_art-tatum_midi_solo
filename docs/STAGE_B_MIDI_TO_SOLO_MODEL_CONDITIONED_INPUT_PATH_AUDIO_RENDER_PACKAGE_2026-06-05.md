...
- rank `2` sample `2` seed `498`: `outputs/stage_b_midi_to_solo_model_conditioned_input_path_audio_render_package/harness_stage_b_midi_to_solo_model_conditioned_input_path_audio_render_package/audio/rank_02_sample_02.wav`, duration `21.355`, sample rate `44100`, size `3767084`, sha256 `683ba60bd525`
- rank `3` sample `3` seed `499`: `outputs/stage_b_midi_to_solo_model_conditioned_input_path_audio_render_package/harness_stage_b_midi_to_solo_model_conditioned_input_path_audio_render_package/audio/rank_03_sample_03.wav`, duration `19.585`, sample rate `44100`, size `3454764`, sha256 `c0f273d5e926`
