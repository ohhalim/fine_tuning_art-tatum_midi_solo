...
- `outputs/stage_b_focused_listening_review_notes/harness_stage_b_focused_timing_vocab_focused_listening_notes/focused_listening_review_notes_summary.json`
...
```bash
FOCUSED_RUN_ID=harness_stage_b_focused_timing_vocab_proxy_keep_focused_package RUN_ID=harness_stage_b_focused_timing_vocab_focused_listening_notes bash scripts/agent_harness.sh stage-b-focused-listening-review-notes
```
