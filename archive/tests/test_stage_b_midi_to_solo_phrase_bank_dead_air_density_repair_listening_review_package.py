...
from scripts.build_stage_b_midi_to_solo_phrase_bank_dead_air_density_repair_listening_review_package import (
    BOUNDARY,
    NEXT_BOUNDARY,
    StageBMidiToSoloPhraseBankDeadAirDensityRepairListeningPackageError,
...
class StageBMidiToSoloPhraseBankDeadAirDensityRepairListeningPackageTest(unittest.TestCase):
    ...
    def test_rejects_upstream_quality_claim(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            with self.assertRaises(StageBMidiToSoloPhraseBankDeadAirDensityRepairListeningPackageError):
                build_listening_review_package_report(
