...
from scripts.guard_stage_b_midi_to_solo_phrase_bank_cli_listening_review_input import (
    ...
    StageBMidiToSoloPhraseBankCliListeningInputGuardError,
...
class StageBMidiToSoloPhraseBankCliListeningInputGuardTest(unittest.TestCase):
    ...
    def test_rejects_upstream_quality_claim(self) -> None:
        with self.assertRaises(StageBMidiToSoloPhraseBankCliListeningInputGuardError):
            build_listening_review_input_guard_report(
