...
from scripts.decide_stage_b_midi_to_solo_controlled_scale_checkpoint_training_scale_dead_air_repeatability_temperature_guard import (
    BOUNDARY,
    NEXT_BOUNDARY,
    SOURCE_BOUNDARY,
    StageBMidiToSoloControlledScaleCheckpointTrainingScaleDeadAirRepeatabilityTemperatureGuardDecisionError,
...
def repeatability_report(
    *,
    ...
    return {
        "schema_version": "stage_b_midi_to_solo_controlled_scale_checkpoint_training_scale_dead_air_repair_repeatability_probe_v1",
        ...
        "readiness": {
            ...
            "selected_scale_dead_air_repair_repeatability_target_qualified": target_qualified,
...
class StageBMidiToSoloControlledScaleCheckpointTrainingScaleDeadAirRepeatabilityTemperatureGuardDecisionTest(
    unittest.TestCase
):
