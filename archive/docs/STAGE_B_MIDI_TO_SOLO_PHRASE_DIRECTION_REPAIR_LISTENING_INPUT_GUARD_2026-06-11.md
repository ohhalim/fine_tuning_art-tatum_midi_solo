...
- listening input path: `outputs/music_transformer_finetune_mvp/solo_yield_phrase_direction_repair_listening_review/issue_1278_phrase_direction_listening_package/listening_review_input_template.json`
- schema matched: `true`
