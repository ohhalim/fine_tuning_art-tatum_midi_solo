...
- listening input path: `outputs/music_transformer_finetune_mvp/solo_yield_chord_role_balance_repair_listening_review/issue_1288_chord_role_balance_listening_package/listening_review_input_template.json`
- schema matched: `true`
