...
from scripts.run_stage_b_midi_to_solo_controlled_scale_checkpoint_dead_air_repeatability_temperature_guard_repair_probe import (
    BOUNDARY,
    FAIL_NEXT_BOUNDARY,
    PASS_NEXT_BOUNDARY,
    SOURCE_BOUNDARY,
    StageBMidiToSoloControlledScaleCheckpointDeadAirRepeatabilityTemperatureGuardRepairProbeError,
    build_repair_report,
...
def guard_decision_report(
    *,
    ...
    return {
        "schema_version": "stage_b_midi_to_solo_controlled_scale_checkpoint_dead_air_repeatability_temperature_guard_decision_v1",
...
class StageBMidiToSoloControlledScaleCheckpointDeadAirRepeatabilityTemperatureGuardRepairProbeTest(
    unittest.TestCase
):
    def test_validates_guard_decision(self) -> None:
        ...
        self.assertEqual(summary["seeds"], [44, 52, 60])
    ...
    def test_builds_qualified_repair_report(self) -> None:
        ...
        self.assertTrue(summary["temperature_guard_repair_target_qualified"])
    ...
    def test_builds_partial_repair_report(self) -> None:
        ...
        report = build_repair_report(
            ...
            seed_rows=[
                seed_row(44),
                seed_row(52),
                seed_row(60, strict_count=2, failures={"dead-air ratio too high: 0.812 >= 0.800": 1}),
            ],
            issue_number=568,
        )
        summary = validate_repair_report(
        ...
        self.assertFalse(summary["temperature_guard_repair_target_qualified"])
