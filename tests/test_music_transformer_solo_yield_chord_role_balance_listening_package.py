...
from scripts.build_music_transformer_solo_yield_chord_role_balance_listening_package import (
    INPUT_SCHEMA_VERSION,
    NEXT_BOUNDARY,
    SCHEMA_VERSION,
    SoloYieldChordRoleBalanceListeningPackageError,
...
class MusicTransformerSoloYieldChordRoleBalanceListeningPackageTest(unittest.TestCase):
    ...
    def test_rejects_quality_claim(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
            with self.assertRaises(SoloYieldChordRoleBalanceListeningPackageError):
                build_listening_package(
