...
from scripts.build_stage_b_midi_to_solo_model_conditioned_input_path_dead_air_timing_repair_pitch_contour_listening_review_package import (
    BOUNDARY,
    NEXT_BOUNDARY,
    StageBMidiToSoloModelConditionedInputPathDeadAirTimingRepairPitchContourListeningReviewPackageError,
...
class StageBMidiToSoloModelConditionedInputPathDeadAirTimingRepairPitchContourListeningReviewPackageTest(
    unittest.TestCase
):
    ...
    def test_boundary_constants_are_stable(self) -> None:
        ...
        self.assertEqual(
            NEXT_BOUNDARY,
            "stage_b_midi_to_solo_model_conditioned_input_path_dead_air_timing_repair_pitch_contour_listening_review_input_guard",
        )
