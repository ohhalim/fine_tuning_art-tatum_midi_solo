...
from scripts.render_stage_b_midi_to_solo_model_conditioned_input_path_dead_air_timing_repair_audio import (
    BOUNDARY,
    NEXT_BOUNDARY,
    StageBMidiToSoloModelConditionedInputPathDeadAirTimingRepairAudioError,
...
def source_report(root: Path, *, quality_claim: bool = False) -> dict:
        ...
        rows.append(
            {
                ...
                "repaired_metrics": {
                    "note_count": 46,
                    "unique_pitch_count": 30 + index,
                    "max_simultaneous_notes": 1,
                    "dead_air_ratio": 0.0,
                    "max_interval": 62,
                },
                "repair_stats": {
                    "added_note_ratio": 0.9166666666666666,
    ...
    return {
        ...
        "readiness": {
            ...
            "dead_air_timing_audio_render_required": True,
...
class StageBMidiToSoloModelConditionedInputPathDeadAirTimingRepairAudioTest(
    unittest.TestCase
):
    def test_renders_repaired_midi_to_wav_without_quality_claim(self) -> None:
        ...
        self.assertTrue(summary["dead_air_timing_repair_audio_package_completed"])
        ...
        self.assertTrue(summary["remaining_wide_interval_risk"])
