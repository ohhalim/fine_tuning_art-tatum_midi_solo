...
from scripts.build_music_transformer_solo_yield_chord_tone_landing_listening_package import (
    NEXT_BOUNDARY,
    SCHEMA_VERSION,
    SoloYieldChordToneLandingListeningPackageError,
...
class MusicTransformerSoloYieldChordToneLandingListeningPackageTest(unittest.TestCase):
    ...
    def test_rejects_quality_claim(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
            with self.assertRaises(SoloYieldChordToneLandingListeningPackageError):
                build_listening_package(
