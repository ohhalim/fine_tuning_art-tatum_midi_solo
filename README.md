...
Validity gate는 density별 최소 노트 수도 확인합니다. 2-bar 기준 최소값은 sparse `3`, medium `4`, dense `8`입니다. 이 기준보다 적은 model candidate는 valid output으로 인정하지 않고 다른 후보 또는 fallback으로 넘어갑니다.
