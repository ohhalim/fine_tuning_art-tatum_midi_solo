...
| current evidence boundary | `stage_b_midi_to_solo_controlled_scale_checkpoint_repair_decision` |
...
- evidence boundary: `stage_b_midi_to_solo_controlled_scale_checkpoint_repair_decision`
- documentation status: `stage_b_midi_to_solo_controlled_scale_checkpoint_repair_decision`
- next engineering boundary: `stage_b_midi_to_solo_controlled_scale_checkpoint_density_collapse_repair_probe`
