...
- duration/coverage fill MIDI evidence consolidation에서 boundary `midi_evidence_preference_support`로 정리
...
| distinct sample-seed sweep boundary | `distinct_sample_seed_qualified_candidate_found` |
| distinct sample-seed context candidate | `margin_recovered_phrase_vocab_seed_109_topk_7_temp_082_n48_sample_47` |
| distinct sample seed | `155` |
...
| distinct sample-seed repair sweep result | target-qualified `0/96` |
...
| duration coverage focused context decision | `keep_for_focused_listening` |
...
| duration coverage MIDI evidence consolidation | boundary `midi_evidence_preference_support`, human/audio proof 미검증 |
